...
{
    public class ViewSystemServiceResource : SystemResource
    {
        public ViewSystemServiceResource() : base("View", "tacticsWar") { }
    }
    public partial class ViewSystemService: ISystemService<ViewSystemServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<ViewSystemServiceResource, ViewSystemService>();
            }
        }
        ...
        {
            return new ViewSystemDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new ViewSystemDeployment();
