...
{
    public class GameBoardSystemServiceResource : SystemResource
    {
        public GameBoardSystemServiceResource() : base("GameBoard", "tacticsWar") { }
    }
    public partial class GameBoardSystemService: ISystemService<GameBoardSystemServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<GameBoardSystemServiceResource, GameBoardSystemService>();
            }
        }
        ...
        {
            return new GameBoardSystemDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new GameBoardSystemDeployment();
