...
{
    public class MoveSystemServiceResource : SystemResource
    {
        public MoveSystemServiceResource() : base("Move", "tacticsWar") { }
    }
    public partial class MoveSystemService: ISystemService<MoveSystemServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<MoveSystemServiceResource, MoveSystemService>();
            }
        }
        ...
        {
            return new MoveSystemDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new MoveSystemDeployment();
