...
{
    public class CombatSystemServiceResource : SystemResource
    {
        public CombatSystemServiceResource() : base("Combat", "tacticsWar") { }
    }
    public partial class CombatSystemService: ISystemService<CombatSystemServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<CombatSystemServiceResource, CombatSystemService>();
            }
        }
        ...
        {
            return new CombatSystemDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new CombatSystemDeployment();
