...
{
    public class BuySystemServiceResource : SystemResource
    {
        public BuySystemServiceResource() : base("Buy", "tacticsWar") { }
    }
    public partial class BuySystemService: ISystemService<BuySystemServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<BuySystemServiceResource, BuySystemService>();
            }
        }
        ...
        {
            return new BuySystemDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new BuySystemDeployment();
