...
{
    public class GameModeSystemServiceResource : SystemResource
    {
        public GameModeSystemServiceResource() : base("GameMode", "tacticsWar") { }
    }
    public partial class GameModeSystemService: ISystemService<GameModeSystemServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<GameModeSystemServiceResource, GameModeSystemService>();
            }
        }
        ...
        {
            return new GameModeSystemDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new GameModeSystemDeployment();
